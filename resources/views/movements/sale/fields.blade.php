<div class="form-group col-md-12">
    <div>
        ...
        <input type="hidden" name="voucher_type_id" id="voucher_type_id" value="{{isset($sale->voucher_type->id)? $sale->voucher_type->id: 0 }}}}">
    ...
    <div>
        ...
        <div class="form-group col-sm-6">
            ...
            <input type="hidden" name="client_id" id="client_id" value="{{ isset($sale->client->id)? $sale->client->id:'' }}">
        ...
        <input type="date" class="form-control" name="date" value="{{ isset($sale->date)? $sale->date: '' }}" required >
        </div>
    </div>
...
<div class="modal fade modal-default" id="modal-new-client" tabindex='-1'>
    <div class="modal-dialog">
        <div class="modal-content">
            
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true" onClick="emptyFormClient();">&times;</button>
                <h4 class="modal-title">Nuevo Cliente!</h4>
            </div>
            <div id="messageError"></div>
            <form id="frmClient" method="POST" action="http://127.0.0.1:8000/mantenimiento/cliente" accept-charset="UTF-8" enctype="multipart/form-data">    
                @include('movements.sale.fields_client')
            </form>

            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal" onClick="emptyFormClient();">Cancelar</button>
                <button type="button" id="btnSaveClient" class="btn btn-danger">Guardar</button>
            </div>
