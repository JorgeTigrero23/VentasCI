                ...
                <li class="dropdown user user-menu" id="user_menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            @if(isset(Auth::user()->image))
                                <img src="{{ asset('profile/'. Auth::user()->image) }}" alt="{{Auth::user()->name}}" class="user-image">
                            @else
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                @if(isset(Auth::user()->image))
                                    <img src="{{ asset('profile/'. Auth::user()->image) }}" alt="{{Auth::user()->name}}" class="img-circle">
                                @else
                                    <img src="{{ asset('img/avatar_none.png') }}" class="img-circle" alt="User Image" />
                                @endif
                                <p>
                                    {{ Auth::user()->name }}
